...
= 10.5.0-dev 2025-11-25 =

**WooCommerce**

* Fix - Adds validation for currency support on PayPal Standard based on the official PayPal currency table for the Orders V2 API. [#61919](https://github.com/woocommerce/woocommerce/pull/61919)
...
* Fix - Redirect payments-related tasks to the Payments Settings page. [#61715](https://github.com/woocommerce/woocommerce/pull/61715)
