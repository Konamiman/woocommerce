...
use Automattic\WooCommerce\Api\Queries\Coupons\GetCoupon2 as GetCoupon2Command;
...
class GetCoupon2 {
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\WooCommerce\Api\Infrastructure\ClassResolver::resolve_class( GetCoupon2Command::class );
